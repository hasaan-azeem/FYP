...
const CTA = () => {
  return (
    ...
    <section className="bg-gray-950 flex justify-center pb-30">
      ...
      <div className="relative w-full p-10 bg-linear-to-br from-[#059669]/40 to-[#059669]/10 rounded-2xl border-2 border-[#059669]">
        ...
        <div className="relative z-10 text-center lg:text-left">
          ...
          <p className="text-gray-300 text-lg mb-6">
            Don't leave your systems exposed. Run a vulnerability assessment now
            and ensure your web applications are fully protected against all
            vulnerabilities.
          </p>
