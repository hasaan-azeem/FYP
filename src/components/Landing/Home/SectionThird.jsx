      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 flex flex-col lg:flex-row gap-12">
        ...
        <div className="lg:w-1/3">
          ...
          <div className="flex items-center space-x-2">
            <a
              href="/signup"
              className="relative text-gray-100 font-semibold group"
            >
              Explore More
        ...
        <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-linear-to-br from-[#059669]/30 to-[#059669]/10 p-6 border border-[#059669] rounded-xl shadow-lg hover:scale-105 transition-transform duration-300"
            >
              <div className="mb-4">
                <svg
