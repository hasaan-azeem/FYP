      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="md:w-3/4 flex flex-col justify-center">
          ...
          <p className="text-gray-300 text-lg mb-6">
            ...
            prime target for attacks. WebXGaurd provides continuous monitoring
        ...
        <div className="md:w-1/4 relative flex justify-center">
          <div className="absolute w-48 h-48 bg-[#059669] opacity-20 blur-3xl rounded-full top-0 left-1/2 transform -translate-x-1/2"></div>
          <img
